...
| Driver's door remote mirror control missing — open hole in the trim panel where the adjuster joystick and its bezel belong | Cosmetic; not an inspection item | Open — **look behind the panel before buying**. Knob and cable still there → a **$35 bezel** (GM `20086901`); knob and cable gone → a **complete LH remote mirror, $140–180**, because the cable is swaged to the mirror head and is not a service part. Parts, prices and the wrong-mirror trap in [`remote-mirror.md`](remote-mirror.md) | — |
