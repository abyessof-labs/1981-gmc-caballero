...
- **78–81 long rectangular speedometer** — almost certainly this car. Base Z88 trim, and 1981 is
  inside the 78–81 range. Dixie `DM00033 RECTANGLE`, SS396 `ISC-0754`, Eckler's `50-306941`.
- **78–88 round gauges** — the gauge-package cluster. Dixie `DM00033 ROUND`, Chevelle Depot's
  "for gauge cars" listing.

**Confirm by looking at your own cluster before ordering.** If the speedometer is a wide horizontal
ribbon, it is the rectangular cable.
